    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <Card className="p-3">
          ...
          <p className="mt-1 text-base font-semibold text-destructive">{formatCurrency(totals.aPagar)}</p>
        </Card>
        <Card className="p-3">
          <div className="flex items-center gap-1.5">
          ...
          <p className="mt-1 text-base font-semibold text-green-600 dark:text-green-400">{formatCurrency(totals.aReceber)}</p>
        </Card>
        <Card className="p-3">
          <div className="flex items-center gap-1.5">
          ...
          <p className={`mt-1 text-base font-semibold ${totals.saldo >= 0 ? 'text-green-600 dark:text-green-400' : 'text-destructive'}`}>
      ...
      {grouped.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-2 py-10 text-center text-muted-foreground">
          ...
          <p className="text-xs">Agende contas ou cadastre recorrentes para visualizar o fluxo projetado.</p>
        </div>
      ) : (

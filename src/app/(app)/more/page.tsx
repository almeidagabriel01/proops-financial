...
import { MessageCircle, Target, Upload, Settings, Wallet, Sliders, FileText } from 'lucide-react';
...
const menuItems = [
  ...
  { href: '/more/irpf', icon: FileText, label: 'Declaração de IR', description: 'Despesas dedutíveis no IRPF', color: 'text-teal-600 bg-teal-500/10' },
